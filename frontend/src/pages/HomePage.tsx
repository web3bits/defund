...
export const HomePage = () => {
  ...
  return (
      ...
      <Typography component="h1" variant="h2" color={ isAuthenticated && user ? "primary.dark" : "primary.light" } gutterBottom>
          <Box sx={{ fontWeight: 900 }}>{ isAuthenticated && user ? "WELCOME IN DEFUND" : "DEFUND IS DECENTRALIZED FUNDRAISER" }</Box>
        </Typography>
